...
export function judgeDelta(before: JudgeStats, after: JudgeStats): Tier2DetectStats {
  return {
    ...
    messageScopeCalls: after.messageScopeCalls - before.messageScopeCalls,
    messageScopeJudged: after.messageScopeJudged - before.messageScopeJudged,
    messageScopeFailedClosed: after.messageScopeFailedClosed - before.messageScopeFailedClosed,
