  ...
  for (const j of jobs) {
    ...
    const footer = j.pdf === "paper.pdf"
      ? { displayHeaderFooter: true, headerTemplate: "<span></span>",
          footerTemplate: "<div style='width:100%;font:7pt Helvetica,Arial,sans-serif;color:#666;padding:0 13mm;display:flex;justify-content:space-between'><span>AI-DLPP · capability-ceiling study · draft v3</span><span><span class='pageNumber'></span> / <span class='totalPages'></span></span></div>",
